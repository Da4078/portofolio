...
const projects = [
    {
        id: 1,
        title: "Discover Bruges",
        description: "A modern, multilingual travel website template built with React and Vite",
    ...
    return <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="text-center mt-12">
                <a className="cosmic-button w-fit flex items-center mx-auto gap-2" href="https://github.com/Da4078">
